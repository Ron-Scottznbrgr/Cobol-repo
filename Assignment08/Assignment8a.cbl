       ...
       03  WS-REG OCCURS 4 ASCENDING KEY WS-LETTER INDEXED BY REGION-IX.
               05  WS-LETTER PIC X.
      ...
      *
       ...
       PROCESS-REC.
           ...
           END-IF     
           IF IN-REGION NOT EQUAL WS-RG
             AND WS-REGN NOT EQUAL LOW-VALUES
               PERFORM END-OF-REGION
           END-IF
           IF IN-REGION NOT EQUAL WS-RG
      ...
      *    e) Add IN-Sales to the region and grand totals
           ADD IN-SALES TO WS-REGION-TOT GIVING WS-REGION-TOT
           ADD IN-SALES TO WS-GRAND-TOT GIVING WS-GRAND-TOT
